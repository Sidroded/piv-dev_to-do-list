...
Спосіб 1. Завантажити .арк файл через Firebase https://appdistribution.firebase.dev/i/28216b384dc2d94f встановити файл з назвою "To Do List - piv.dev.apk" на ваш пристрій та запустити його через піктограму на робочому столі, після чого відкриється вікно з входом до акаунту. 
